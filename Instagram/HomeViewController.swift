...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //要素が変更されたら該当のデータをpostArrayから一度削除した後に新しいデータを追加してtableViewに再表示する
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //UILabelの行数が変わっている可能性があるので再描写させる
        cell.layoutIfNeeded()
    ...
    func commentButton(sender: UIButton, event:UIEvent) {
        ...
        let sender = ud.objectForKey(CommonConst.DisplayNameKey) as! String
        
        postData.comments.append("\(sender) : ありがとう")
